...
- **v1.3.0** (2026-01-05): 반응형 레이아웃 대응 (창 크기 자동 관리)
  - **자동 창 크기 관리**: 브라우저 연결 시 자동으로 최대화
  - **폴백 크기 설정**: 최대화 실패 시 1920x1080으로 고정
  - **반응형 디자인 대응**: 축소/전체화면에 관계없이 일관된 레이아웃
  - **모바일 레이아웃 방지**: 창이 작아 모바일 뷰가 나오는 문제 해결
